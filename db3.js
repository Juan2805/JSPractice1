...
// for (var i = 0; i < rickAndMortyApi.results.length; i++) {
//     console.log(`The species of ${rickAndMortyApi.results[i].name} is ${rickAndMortyApi.results[i].species} and his origin is ${rickAndMortyApi.results[i].origin.name}, his episode count is ${rickAndMortyApi.results[i].episode.length}`)
// }

// let keys = Object.keys(rickAndMortyApi.info)
// console.log(keys)

// let asd = Object.values(rickAndMortyApi.info)
// console.log(asd)

// for (let [key, value] of Object.entries(rickAndMortyApi.info)) {
